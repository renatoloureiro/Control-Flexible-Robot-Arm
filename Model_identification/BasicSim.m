...
% PRBS input
    ...
    PRBS.ref=idinput(length(PRBS.time),'PRBS',[0 0.008]);
...
% Square input
    ...
    Square.freq=0.1;  %Hertz
    Square.ref=10*square(2*pi*Square.freq*Square.time);
...
% earlier
    ...
    gg=xlabel('Tempo [s]');
    set(gg,'FontSize',14);
    gg=ylabel('Velocidade Angular [rad/s]');
    set(gg,'Fontsize',14);
    %xlim([10 35]);
    hold on
